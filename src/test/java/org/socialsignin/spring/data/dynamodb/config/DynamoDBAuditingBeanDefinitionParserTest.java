...
public class DynamoDBAuditingBeanDefinitionParserTest {
  ...
  public void setUp() throws Exception {
    ...
    readerContext = new XmlReaderContext(resource, problemReporter, eventListener, sourceExtractor,
    ...
    when(beanNameGenerator.generateBeanName(any(), eq(registry)))
        .thenReturn("dynamoDBMappingContext");
  }
