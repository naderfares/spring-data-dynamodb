...
public class CRUDOperationsIT {
  ...
  public void testFilterWithCollections() {
    ...
    assertEquals(notTagA,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(setOf("tag-a"))));
    assertEquals(notTagB,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(setOf("tag-b"))));
    assertEquals(notTagC,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(setOf("tag-c"))));
    ...
    assertEquals(notTagA,
        new HashSet<>(userRepository.findAllByTagsNotContaining(listOf("tag-a"))));
    assertEquals(notTagB,
        new HashSet<>(userRepository.findAllByTagsNotContaining(listOf("tag-b"))));
    assertEquals(notTagC,
        new HashSet<>(userRepository.findAllByTagsNotContaining(listOf("tag-c"))));
    ...
    assertEquals(notTagA,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(listOf("tag-a"))));
    assertEquals(notTagB,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(listOf("tag-b"))));
    assertEquals(notTagC,
        new HashSet<>(userRepository.findAllByTagsIsNotContaining(listOf("tag-c"))));
