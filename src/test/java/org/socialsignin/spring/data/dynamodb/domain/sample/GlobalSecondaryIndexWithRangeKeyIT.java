...
@ContextConfiguration(
    classes = {DynamoDBLocalResource.class, GlobalSecondaryIndexWithRangeKeyIT.TestAppConfig.class})
...
public class GlobalSecondaryIndexWithRangeKeyIT {
  ...
  public void testFindBySystemIdOrderByUpdatedAtDesc() {
    ...
    final List<Installation> actual =
        installationRepository.findBySystemIdOrderByUpdatedAtDesc("systemId");
