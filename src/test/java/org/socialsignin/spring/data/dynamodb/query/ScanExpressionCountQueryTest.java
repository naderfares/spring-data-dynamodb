...
public class ScanExpressionCountQueryTest {
  ...
  public void testScanCountEnabledTrueTrue() {
    underTest =
        new ScanExpressionCountQuery<>(dynamoDBOperations, User.class, scanExpression, true);
  ...
  public void testScanCountEnabledFalseTrue() {
    underTest =
        new ScanExpressionCountQuery<>(dynamoDBOperations, User.class, scanExpression, false);
