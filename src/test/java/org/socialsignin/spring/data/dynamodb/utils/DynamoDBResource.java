...
/**
 * Clue {@link Configuration} class for all integration tests. It exposes the {@link AmazonDynamoDB}
 * pre-configured to use the launched local DynamoDB by Maven's integration-test.
 */
@Configuration
public class DynamoDBResource {
  ...
  public AmazonDynamoDB amazonDynamoDB() {
    ...
    builder
        .withCredentials(new AWSStaticCredentialsProvider(new BasicAWSCredentials("AWS-Key", "")));
