...
import io.github.naderfares.spring.data.dynamodb.domain.sample.CustomerHistory;
import io.github.naderfares.spring.data.dynamodb.domain.sample.CustomerHistoryRepository;
...
public class CustomerHistoryTest {
    ...
    @Configuration
    @EnableDynamoDBRepositories(basePackages = "io.github.naderfares.spring.data.dynamodb.domain.sample")
