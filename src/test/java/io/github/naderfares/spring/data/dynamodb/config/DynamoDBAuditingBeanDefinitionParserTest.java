 ...
 */
package io.github.naderfares.spring.data.dynamodb.config;

import io.github.naderfares.spring.data.dynamodb.mapping.DynamoDBMappingContext;
import io.github.naderfares.spring.data.dynamodb.mapping.event.AuditingEventListener;
...
public class DynamoDBAuditingBeanDefinitionParserTest {
    ...
    public void testDoParseWithMappingContext() {
        ...
        String mappingContextRef = BeanNames.MAPPING_CONTEXT_BEAN_NAME;
    ...
    public void testDoParseWithoutMappingContextAutocreatingBean() {
        ...
        when(registry.containsBeanDefinition(BeanNames.MAPPING_CONTEXT_BEAN_NAME)).thenReturn(false);

        underTest.doParse(configElement, parserContext, builder);

        verify(registry).registerBeanDefinition(BeanNames.MAPPING_CONTEXT_BEAN_NAME,
    ...
    public void testDoParseWithoutMappingContextReusingBean() {
        ...
        // Default bean not yet registered
        when(registry.containsBeanDefinition(BeanNames.MAPPING_CONTEXT_BEAN_NAME)).thenReturn(true);
