...
import io.github.naderfares.spring.data.dynamodb.domain.sample.AuditableUser;
import io.github.naderfares.spring.data.dynamodb.repository.config.EnableDynamoDBRepositories;
...
import io.github.naderfares.spring.data.dynamodb.domain.sample.AuditableUserRepository;
import io.github.naderfares.spring.data.dynamodb.utils.DynamoDBLocalResource;
...
public class AuditingViaJavaConfigRepositoriesIT {
    ...
    @EnableDynamoDBRepositories(mappingContextRef = "dynamoDBMappingContext", basePackages = "io.github.naderfares.spring.data.dynamodb.domain.sample")
