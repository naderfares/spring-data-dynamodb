...
public @interface EnableDynamoDBRepositories {
    ...
    /**
     * Returns the {@link javax.validation.Validator } reference to be used for to validate DynamoDB entities
     *
     * @return The {@link DynamoDBOperations} bean name
     */
    String dynamoDBOperationsRef() default "";

    /**
     * Returns the {@link DynamoDBMappingContext} reference for the
     * {@link org.springframework.data.mapping.context.MappingContext} for AmazonDynamoDB.
     *
     * @return The {@link DynamoDBMappingContext} bean name
     */
