 ...
 */
package io.github.naderfares.spring.data.dynamodb.repository.cdi;

import com.amazonaws.services.dynamodbv2.AmazonDynamoDB;
import com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapper;
import com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapperConfig;
import io.github.naderfares.spring.data.dynamodb.repository.support.DynamoDBRepositoryFactory;
...
class DynamoDBRepositoryBean<T> extends CdiRepositoryBean<T> {
     ...
     * (non-Javadoc)
     * 
     * @see javax.enterprise.context.spi.Contextual#create(javax.enterprise .context.spi.CreationalContext, Class<T>,
     * Optional<Object>)
     */
    @Override
