 ...
 *             at some point {@link DynamoDBMarshaller} might be cached - whereas {@link DateFormat}
 *             is not thread-safe. <br>
 *             Use {@link org.socialsignin.spring.data.dynamodb.marshaller.DateDynamoDBMarshaller}
 *             instead.
 *
  ...
  public Date unmarshall(Class<Date> clazz, String obj) throws IllegalArgumentException {
    if (obj == null) {
      ...
      try {
        ...
        throw new IllegalArgumentException("Could not unmarshall '" + obj + "' via " + dateFormat,
            e);
      }
    }
  }
