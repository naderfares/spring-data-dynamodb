...
/**
 * Annotation to enable DynamoDB repositories. Will scan the package of the annotated configuration
...
public @interface EnableDynamoDBRepositories {
   ...
   * declarations e.g.: {@code @EnableDynamoDBRepositories("org.my.pkg")} instead of
   ...
   * implementation class will be looked up scanning for {@code PersonRepositoryImpl}. Defaults to
   * 'Impl'.
   *
   ...
   * default to {@code META-INFO/jpa-named-queries.properties}.
   *
   ...
   * be used for lookup queries for query methods. Defaults to {@link Key#CREATE_IF_NOT_FOUND}.
   *
   ...
   * repository instance. Defaults to {@link DynamoDBRepositoryFactoryBean}.
   *
  ...
  /**
   * Returns the {@link com.amazonaws.services.dynamodbv2.AmazonDynamoDB } reference to be used for
  ...
  /**
   * Returns the {@link com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapperConfig }
   * reference to be used for to configure AmazonDynamoDB
   *
   * @return The {@link com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapperConfig} bean
   *         name
   */
  String dynamoDBMapperConfigRef() default "";

  /**
   * Returns the {@link com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapper } reference to
   * be used
   *
  ...
  /**
   * Returns the {@link jakarta.validation.Validator } reference to be used for to validate DynamoDB
   * entities
   *
  ...
  /**
   * Returns the {@link org.socialsignin.spring.data.dynamodb.mapping.DynamoDBMappingContext}
   * reference for the {@link org.springframework.data.mapping.context.MappingContext} for
   * AmazonDynamoDB.
   *
   * @return The {@link org.socialsignin.spring.data.dynamodb.mapping.DynamoDBMappingContext} bean
   *         name
   */
