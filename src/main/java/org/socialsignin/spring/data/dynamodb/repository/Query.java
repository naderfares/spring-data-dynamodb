...
public @interface Query {
  ...
  /**
   * A string that identifies the attributes you want. To retrieve a single attribute, specify its
   * name. For multiple attributes, the names must be comma-separated.
   *
   * @see <a href=
