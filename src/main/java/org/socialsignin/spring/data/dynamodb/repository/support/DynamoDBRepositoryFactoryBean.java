...
/**
 * Special adapter for Springs {@link org.springframework.beans.factory.FactoryBean} interface to
 * allow easy setup of repository factories via Spring configuration.
 *
...
public class DynamoDBRepositoryFactoryBean<T extends Repository<S, ID>, S, ID extends Serializable>
  ...
  protected RepositoryFactorySupport createRepositoryFactory() {
    ...
    DynamoDBRepositoryFactory dynamoDBRepositoryFactory =
        new DynamoDBRepositoryFactory(dynamoDBOperations);
  ...
  @Autowired
  public void setEntity2DynamoDBTableSynchronizer(
      Entity2DynamoDBTableSynchronizer<S, ID> tableSynchronizer) {
