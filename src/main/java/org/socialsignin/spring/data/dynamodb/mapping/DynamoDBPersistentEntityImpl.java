 ...
 */
public class DynamoDBPersistentEntityImpl<T> extends
    BasicPersistentEntity<T, DynamoDBPersistentProperty> implements DynamoDBPersistentEntity<T> {
  ...
  /**
   * Returns the given property if it is a better candidate for the id property than the current id
   * property.
   *
