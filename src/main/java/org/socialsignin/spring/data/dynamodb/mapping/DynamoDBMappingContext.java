...
/**
 * Default implementation of a {@link org.springframework.data.mapping.context.MappingContext} for
 * DynamoDB using {@link DynamoDBPersistentEntityImpl} and {@link DynamoDBPersistentProperty} as
...
public class DynamoDBMappingContext
   ...
   */
  @Override
  protected <T> DynamoDBPersistentEntityImpl<?> createPersistentEntity(
