...
/**
 * {@link Page} implementation that uses only the methods from the {@link Iterable} interface thus
 * the lazy list from the AWS SDK used as result set can be properly used
 *
