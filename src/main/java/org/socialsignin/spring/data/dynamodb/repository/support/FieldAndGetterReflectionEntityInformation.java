...
/**
 * {@link org.springframework.data.repository.core.EntityInformation} implementation that inspects
 * getters for an annotation and invokes this getter's value to retrieve the id.
 *
...
public class FieldAndGetterReflectionEntityInformation<T, ID>
  ...
  /**
   * Creates a new {@link FieldAndGetterReflectionEntityInformation} inspecting the given domain
   * class for a getter carrying the given annotation.
   *
