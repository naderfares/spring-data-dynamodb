...
public class DynamoDBEntityMetadataSupport<T, ID>
  ...
  /**
   * Creates a new {@link DynamoDBEntityMetadataSupport} for the given domain type and dynamoDB
   * mapper config.
   *
   * @param domainType must not be {@literal null}.
   * @param dynamoDBOperations dynamoDBOperations as populated from Spring Data DynamoDB
   *        Configuration
   */
  public DynamoDBEntityMetadataSupport(final Class<T> domainType,
  ...
  public DynamoDBEntityInformation<T, ID> getEntityInformation() {
    ...
    if (hasRangeKey) {
      DynamoDBHashAndRangeKeyExtractingEntityMetadataImpl<T, ID> metadata =
          new DynamoDBHashAndRangeKeyExtractingEntityMetadataImpl<T, ID>(domainType);
  ...
  public String getOverriddenAttributeName(Method method) {
    ...
    if (method != null) {
      ...
      if (method.getAnnotation(DynamoDBIndexRangeKey.class) != null && !StringUtils
          .isEmpty(method.getAnnotation(DynamoDBIndexRangeKey.class).attributeName())) {
        return method.getAnnotation(DynamoDBIndexRangeKey.class).attributeName();
      }
      if (method.getAnnotation(DynamoDBIndexHashKey.class) != null && !StringUtils
          .isEmpty(method.getAnnotation(DynamoDBIndexHashKey.class).attributeName())) {
        return method.getAnnotation(DynamoDBIndexHashKey.class).attributeName();
      }
      if (method.getAnnotation(DynamoDBVersionAttribute.class) != null && !StringUtils
          .isEmpty(method.getAnnotation(DynamoDBVersionAttribute.class).attributeName())) {
  ...
  public Optional<String> getOverriddenAttributeName(final String propertyName) {
    ...
    if (field != null) {
      ...
      if (field.getAnnotation(DynamoDBIndexRangeKey.class) != null && !StringUtils
          .isEmpty(field.getAnnotation(DynamoDBIndexRangeKey.class).attributeName())) {
        return Optional.of(field.getAnnotation(DynamoDBIndexRangeKey.class).attributeName());
      }
      if (field.getAnnotation(DynamoDBIndexHashKey.class) != null && !StringUtils
          .isEmpty(field.getAnnotation(DynamoDBIndexHashKey.class).attributeName())) {
        return Optional.of(field.getAnnotation(DynamoDBIndexHashKey.class).attributeName());
      }
      if (field.getAnnotation(DynamoDBVersionAttribute.class) != null && !StringUtils
          .isEmpty(field.getAnnotation(DynamoDBVersionAttribute.class).attributeName())) {
  ...
  private void addGlobalSecondaryIndexNames(Method method,
      DynamoDBIndexRangeKey dynamoDBIndexRangeKey) {
    ...
    if (dynamoDBIndexRangeKey.globalSecondaryIndexName() != null
      ...
      String propertyName = getPropertyNameForAccessorMethod(method);
      globalSecondaryIndexNames.put(propertyName, new String[] {
          method.getAnnotation(DynamoDBIndexRangeKey.class).globalSecondaryIndexName()});
      globalIndexRangeKeyPropertyNames.add(propertyName);
  ...
  private void addGlobalSecondaryIndexNames(Field field,
      DynamoDBIndexRangeKey dynamoDBIndexRangeKey) {
    ...
    if (dynamoDBIndexRangeKey.globalSecondaryIndexName() != null
      ...
      String propertyName = getPropertyNameForField(field);
      globalSecondaryIndexNames.put(propertyName, new String[] {
          field.getAnnotation(DynamoDBIndexRangeKey.class).globalSecondaryIndexName()});
      globalIndexRangeKeyPropertyNames.add(propertyName);
  ...
  private void addGlobalSecondaryIndexNames(Method method,
      DynamoDBIndexHashKey dynamoDBIndexHashKey) {
    ...
    if (dynamoDBIndexHashKey.globalSecondaryIndexName() != null
      ...
      globalSecondaryIndexNames.put(propertyName, new String[] {
          method.getAnnotation(DynamoDBIndexHashKey.class).globalSecondaryIndexName()});
      globalIndexHashKeyPropertyNames.add(propertyName);
  ...
  private void addGlobalSecondaryIndexNames(Field field,
    ...
    if (dynamoDBIndexHashKey.globalSecondaryIndexName() != null
      ...
      globalSecondaryIndexNames.put(propertyName, new String[] {
          field.getAnnotation(DynamoDBIndexHashKey.class).globalSecondaryIndexName()});
      globalIndexHashKeyPropertyNames.add(propertyName);
