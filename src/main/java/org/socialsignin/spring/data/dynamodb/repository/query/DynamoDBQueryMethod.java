...
public class DynamoDBQueryMethod<T, ID> extends QueryMethod {
  ...
  public DynamoDBQueryMethod(Method method, RepositoryMetadata metadata,
    ...
    this.method = method;
    this.scanEnabledForRepository =
        metadata.getRepositoryInterface().isAnnotationPresent(EnableScan.class);
    this.scanCountEnabledForRepository =
        metadata.getRepositoryInterface().isAnnotationPresent(EnableScanCount.class);
