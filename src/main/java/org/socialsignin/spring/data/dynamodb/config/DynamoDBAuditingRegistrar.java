 ...
 * {@link EnableDynamoDBAuditing} annotation.
 *
...
class DynamoDBAuditingRegistrar extends AuditingBeanDefinitionRegistrarSupport {
  ...
  protected BeanDefinitionBuilder getAuditHandlerBeanDefinitionBuilder(
    ...
    BeanDefinitionBuilder persistentEntities =
        rootBeanDefinition(PersistentEntitiesFactoryBean.class);
   ...
   * {@link org.springframework.data.support.IsNewStrategyFactory} in case we don't find beans with
   * the assumed names in the registry.
   *
