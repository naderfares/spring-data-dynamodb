...
/**
 * Encapsulates minimal information needed to load DynamoDB entities that have both hash and range
 * key, and have a composite id attribute annotated with {@link Id}. Delegates to metadata and
 * hashKeyExtractor components for all operations.
 *
