...
/**
 * {@link org.springframework.beans.factory.xml.BeanDefinitionParser} to register a
 * {@link AuditingEventListener} to transparently set auditing information on an entity.
 *
...
public class DynamoDBAuditingBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
   ...
   *
    @see org.springframework.beans.factory.xml.AbstractSingleBeanDefinitionParser#
   * doParse(org.w3c.dom.Element, org.springframework.beans.factory.xml.ParserContext,
  ...
  protected void doParse(Element element, ParserContext parserContext,
    ...
    IsNewAwareAuditingHandlerBeanDefinitionParser parser =
        new IsNewAwareAuditingHandlerBeanDefinitionParser(mappingContextRef);
