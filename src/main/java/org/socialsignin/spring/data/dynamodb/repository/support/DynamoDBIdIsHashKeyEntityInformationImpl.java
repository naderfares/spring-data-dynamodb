 ...
 *
 * Delegates to wrapped DynamoDBHashKeyExtractingEntityMetadata component for many operations - it
 * is the responsibility of calling clients to ensure they pass in a valid
 * DynamoDBHashKeyExtractingEntityMetadata implementation for this entity.
 *
 * Entities of type T must have a public getter method of return type ID annotated
 * with @DynamoDBHashKey to ensure correct behavior
 *
