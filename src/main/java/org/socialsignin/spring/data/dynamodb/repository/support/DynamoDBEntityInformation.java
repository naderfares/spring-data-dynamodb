 ...
 *
 * Implementing classes can elect to be either range-key aware or not. If a subclass is not
 * range-key aware it should return null from getRangeKey(ID id) method, and return false from
