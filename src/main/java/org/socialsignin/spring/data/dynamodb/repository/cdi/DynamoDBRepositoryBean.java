...
class DynamoDBRepositoryBean<T> extends CdiRepositoryBean<T> {
   ...
   * @param amazonDynamoDBBean must not be {@literal null}.
   * @param dynamoDBOperationsBean must not be {@literal null}.
  ...
  DynamoDBRepositoryBean(BeanManager beanManager, Bean<AmazonDynamoDB> amazonDynamoDBBean,
      ...
      Bean<DynamoDBOperations> dynamoDBOperationsBean, Bean<DynamoDBMapper> dynamoDBMapperBean,
  ...
  protected T create(CreationalContext<T> creationalContext, Class<T> repositoryType) {
    ...
    if (dynamoDBOperations == null) {
      dynamoDBOperations =
          new DynamoDBTemplate(amazonDynamoDB, dynamoDBMapper, dynamoDBMapperConfig);
    }
